...
\caption{Pseudocode description of the simplex insertion algorithm in \asc.}
\label{alg:insertion}
\end{algorithm}
		\begin{figure}[ht!]
			\centering
...
\caption{Pseudocode to decimate a simplex by collapsing it into a vertex in \asc.}
...
\caption{Templated pseudocode implementation of Algorithm~\ref{alg:insertion} in \asc.}
