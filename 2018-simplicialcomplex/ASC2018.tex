...
\end{algorithm}
		\begin{figure}[ht!]
			...
			\caption[\asc recursive insertion algorithm]{Recursive insertion of tetrahedral simplex \{1,2,3,4\}. The order of node insertions is represented by the numbered red arrows. When each node is created, the black arrows to parent simplices are created by backfilling.}
			\label{fig:insert}
		\end{figure}
...
\begin{figure}[hp]
	...
	\caption[Step-by-step simplex insertion Hasse diagrams]{
