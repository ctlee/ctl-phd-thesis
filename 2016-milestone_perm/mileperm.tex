...
\clearpage{}
    ...
    \subsection{Permeability from milestoning using crossing probability}
        ...
        \begin{center}
            ...
            \caption{Shown here is the milestoning system setup. The stationary concentrations in the bulk $u_1$ and $u_2$ are subject to boundary conditions at $z=0$ and $z=b$. A permeant that hits the \surf{b} has a probability of $\rho$ to cross the membrane and a probability $1-\rho$ to return to the \surf{q}. These boundaries and domains are not necessarily drawn to scale.}
            \label{fig:prob}
        \end{center}
        \end{figure}
