\documentclass[usetitle=true,journal=jpcbfk,manuscript=suppinfo]{achemso}
\setkeys{acs}{usetitle=true}
\usepackage[version=3]{mhchem}
\usepackage{color}
\usepackage{geometry}           % See options in geometry.pdf
...
\newcommand{\parfrac}[3]{\left(\frac{\partial #1}{\partial #2}\right)_{#3}}
...
\bibitem[O'Neill()]{ONeill}
O'Neill,~M.~E. {PCG: A Family of Simple Fast Space-Efficient Statistically Good
  Algorithms for Random Number Generation}. \emph{ACM Trans. Math. Softw.}. \textit{In Review.}
  \relax
