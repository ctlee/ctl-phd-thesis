...
%                            instead of
%                              1 Title of Chapter
\documentclass[11pt, chapterheads, final]{ucsd}
...
\usepackage[style=chem-acs,backend=biber,defernumbers=true,sorting=none,citecounter,labelnumber]{biblatex}
...
\bibliography{journals_short,permeability,mileperm,asc,allostery,bcd,exascale,ccr2}
